...
const Index = () => {
  ...
  const [ideas, setIdeas] = useState<Idea[]>([
    {
      ...
      finalVerdict: '시장성이 높고 기술적 구현이 가능한 아이디어입니다. B2C 헬스케어 시장의 성장세와 개인화 트렌드에 부합하여 투자 가치가 있다고 판단됩니다.'
    },
    {
      id: '2',
  ...
  // Mock admin check (in real app, this would be based on user authentication)
  ...
  const handleGenerateAnalysis = async (ideaId: string) => {
    ...
    const mockAnalysis = {
      ...
      marketPotential: currentLanguage === 'ko' ? [
      ...
      similarIdeas: currentLanguage === 'ko' ? [
      ...
      pitchPoints: currentLanguage === 'ko' ? [
